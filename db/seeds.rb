...
Post.create(:content => "Wow, this web application sure is neat and was probably made by a very cool dude",:posted_at => Time.now, :user_id => 3)
Post.create(:content => "Where is the delete account button?",:posted_at => Time.now, :user_id => 4)
Post.create(:content => "Poop",:posted_at => Time.now, :user_id => 5)
